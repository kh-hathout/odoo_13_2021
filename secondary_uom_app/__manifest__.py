...

{
    ...
    'summary': 'All secondary unit of measure for Sale secondary unit of measure for Purchase secondary unit of measure for Accounting secondary unit of measure for Inventory all in one secondary uom Sale secondary uom Purchase secondary uom invoice secondary uom for all',
    'description' : '''

                    ...
                    for user in users:
                        notifications.append([
                            ...
                            {'type': 'user_connection', 'title': _(
                                'Notitification'), 'message': 'You have approval notification for sale order %s' % (self.name), 'sticky': True, 'warning': True}])
        ...
        if next_line:
            ...
            if self.user_id:
                notifications.append([
                    ...
                    {'type': 'user_connection', 'title': _(
                        'Notitification'), 'message': 'Dear SalesPerson your order %s is confirmed' % (self.name), 'sticky': True, 'warning': True}])
                self.env['bus.bus'].sendmany(notifications)
